...
<body class="PageBody" style="margin: 0">
	...
	<div id="Head1">
		<div id="Logo">
            ...
            <font color="#0000CC" style="color:#F1F9FE; font-size:28px; font-family:Arial Black, Arial">欢迎光临</font> 
        ...
        <div id="Head1Right_SystemButton">
            <a target="_parent" href="<%=request.getContextPath()%>/loginServlet?method=exit">
    ...
    <div id="Head2">
		...
		<div id="Head2_FunctionList">
			<marquee style="WIDTH: 100%;" onMouseOver="this.stop()" onMouseOut="this.start()" 
				...
				<b>欢迎您:<font color="white">${userinfo.username}</font></b>
			</marquee>
		</div>
	</div>
